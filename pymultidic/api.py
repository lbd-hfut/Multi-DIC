...
_DEFAULT_RAW: dict[str, Any] = {
    ...
    "colmap": {
        ...
        "max_features": 8192,
        "first_octave": -1,
        "feature_grid_columns": 12,
        "feature_grid_rows": 9,
        "feature_candidate_multiplier": 4,
...
_FLAT_OVERRIDE_PATHS: dict[str, tuple[str, ...]] = {
    ...
    "feature_grid_columns": ("colmap", "feature_grid_columns"),
    "feature_grid_rows": ("colmap", "feature_grid_rows"),
    "feature_candidate_multiplier": ("colmap", "feature_candidate_multiplier"),
    "initial_focal_length_factor": ("colmap", "initial_focal_length_factor"),
    ...
    "ba_global_max_num_iterations": ("colmap", "ba_global_max_num_iterations"),
